...
/// 主线任务中的关卡选项条
/// </summary>
public class Item_MainlinePanel : MonoBehaviour
{
    private Button Btn;
    ...
    public static Item_MainlinePanel GetInstance(UnityAction call, int rank, bool isLock, string name, string condition)
    {
        Item_MainlinePanel item = GameManager.Instance.GetGameObjectResource(FactoryType.UIFactory, "MainlinePanel/Item").GetComponent<Item_MainlinePanel>();
        item.Initial();
    ...
    {
        GameManager.Instance.PushGameObjectToFactory(FactoryType.UIFactory, "MainlinePanel/Item", gameObject);
    }
}
