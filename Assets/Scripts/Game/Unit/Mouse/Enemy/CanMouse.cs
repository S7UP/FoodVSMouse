...
public class CanMouse : MouseUnit
{
    ...
    public override void MInit()
    {
        ...
        NumericBox.AddDecideModifierToBoolDict(StringManager.IgnoreFrozen, IgnoreStun);
        // 初始态为重装态
        SetReinstallState();
    }
    ...
    private void SetLightState()
    {
        ...
        NumericBox.RemoveDecideModifierToBoolDict(StringManager.IgnoreFrozen, IgnoreStun);
