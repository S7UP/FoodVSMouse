...
public class Map_LilacRainbow2 : ChapterMap
{
    ...
    public override void CreateGridGoupList()
    {
        ...
        for (int k = 0; k < 7; k++)
        {
            ...
            // 设置中心点坐标
            gridGroup.transform.position = mapCenter + 1f * MapManager.gridWidth * Vector3.left + (3-k)*MapManager.gridHeight * Vector3.up;
            // 加入对应的格子
    ...
    public override void OtherProcessing()
    {
        ...
        //// 添加云层
        //for (int i = 0; i < 7; i++)
        //    Item_Cloud.GetCloudGroup(1, new Vector2(MapManager.GetColumnX(7f), MapManager.GetRowY(i)), 1);
