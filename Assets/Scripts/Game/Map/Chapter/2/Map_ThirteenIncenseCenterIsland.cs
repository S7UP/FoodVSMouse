...
public class Map_ThirteenIncenseCenterIsland : ChapterMap
{
    ...
    public void Awake()
    {
        if (SpriteArray == null)
        {
            ...
            SpriteArray[0] = GameManager.Instance.GetSprite("Chapter/2/14/0");
            SpriteArray[1] = GameManager.Instance.GetSprite("Chapter/2/14/4");
            SpriteArray[2] = GameManager.Instance.GetSprite("Chapter/2/14/5");
        }
    ...
    public override void CreateGridGoupList()
    {
        ...
        // 四个角落
        {
            ...
            {
                MovementGridGroup gridGroup = MovementGridGroup.GetInstance();
                gridGroup.spriteRenderer0.sprite = GameManager.Instance.GetSprite(GetSpritePath() + 3);
                gridGroup.spriteRenderer1.sprite = GameManager.Instance.GetSprite(GetSpritePath() + 3);
                // 设置中心点坐标
